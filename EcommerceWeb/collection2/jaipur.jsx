...
export function Jaipur(props) {
    const [product, setProduct] = useState({ Items14: [{ products: [] }] });
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">ONE STOP DESTINATION FOR COTTON SAREES IN JAIPUR</h5>
                <p className="text-justify">
                    Are you looking for premium Jaipur cotton sarees or a classy Bollywood style cotton saree in Jaipur.
                    We have more than 2500 sarees in Linen, Jaipur Cotton and silk sarees in Jaipur suburbs.
                    You can choose your Jaipuri sarees online for party wear or bridal wear functions from BharatSthali.com.
                </p>
            </div>
            ...
            <div id="product" className="row align-items-center mx-auto justify-content-center w-100">
                {product.Items14.map((resp, index) => (
