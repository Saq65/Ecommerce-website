...
export function Blockprinted(props) {
    const [product, setProduct] = useState({ Items18: [{ products: [] }] });
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">BLOCK PRINTED SAREES</h5>
                <p className="text-justify">
                Authentic hand block printed sarees are available at BharatSthali. These are pure handwork of village artisans of real India and
                 showing a perfect example of art. At BharatSthali, you will find silk & cotton sarees that are economical and hand block printed
                  which makes them unique and attractive.
                </p>
            </div> 
            ...
            <div id="product" className="row align-items-center mx-auto justify-content-center w-100">
                {product.Items18.map((resp, index) => (
