...
export function Ajrakh(props) {
    const [product, setProduct] = useState({ Items21: [{ products: [] }] });
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">AJRAKH PRINTS</h5>
                <p className="text-justify">
                    Choose top quality Ajrakh prints sarees. Ajrakh print sarees are a block-printed textile that is resist-dyed using natural dyes.
                    including indigo and madder.
                    It is made in Kutch, Gujarat and is distinguished by its color- blue with red — and its complex geometric & floral patterns.
                </p>
            </div>
            ...
            <div id="product" className="row align-items-center mx-auto justify-content-center w-100">
                {product.Items21.map((resp, index) => (
