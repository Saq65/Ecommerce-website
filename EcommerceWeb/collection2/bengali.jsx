...
export function Bengali(props) {
    const [product, setProduct] = useState({ Items5: [{ products: [] }] });
    ...
    function Image(e, id) {
        const ids = product.Items5.find(itm => itm.id === id);
        if (ids) {
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">BENGAL COTTON & BALUCHARI SAREES ONLINE</h5>
                <p className="text-justify">
                    Be it Baluchari silk saree or bengal cotton sarees, the sarees from the land of Bengal is mesmerizing and stunning.
                </p>
            </div>
