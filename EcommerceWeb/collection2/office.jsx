...
export function Office(props) {
    const [product, setProduct] = useState({ Items15: [{ products: [] }] });
    ...
    // var info = product.Items15.map((itm)=>itm.images)

    function Image(e, id) {
        const ids = product.Items15.find(itm=>itm.id === id);
        if(ids){
            ...
            navigate('/main',{state :{ info : info,info2:info2,img1:img1,img2:img2, img3:img3,price:price,desc:desc,desc2:desc2,length:length,id:id}})
        }
    }
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">OFFICE / WORK WEAR SAREES ONLINE</h5>
                <p className="text-justify">
                    Bored of wearing business suits to work? Want to look beyond black, white and gray tones ofworkwear sareesthat you can wear to work easily.
                </p>
            </div>
            ...
            <div id="product" className="row align-items-center mx-auto justify-content-center w-100">
                {product.Items15.map((resp, index) => (
