...
export function Maheshwari(props) {
    const [product, setProduct] = useState({ Items7: [{ products: [] }] });
    ...
    function Image(e, id) {
        const ids = product.Items7.find(itm => itm.id === id);
        if (ids) {
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">MAHESHWARI SAREES ONLINE</h5>
                <p className="text-justify">
                    Maheshwari saree is well known for its soft beautiful cotton designs in India. Your search of finding a saree with just the right amount of bling and understated elegance ends here.
                    Bharat Sthali brings you a beautiful selection of Maheshwari sarees online in silk and cotton.
                </p>
            </div>
