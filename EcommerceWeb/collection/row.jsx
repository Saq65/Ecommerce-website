...
import { CurrencyRupee,EmailOutlined,Instagram,Facebook } from "@mui/icons-material";

export function Raw(props) {
    const [product, setProduct] = useState({ Items8: [{ products: [] }] });
    ...
    return (
        <div className="container-fluid-lg">
            ...
            <div id="sareeInfo " className="m-4 mx-3">
                <h5 className="">RAW SILK SAREES ONLINE</h5>
                <p className="text-justify">
                    Pure Raw silk sarees have their own ethereal and rusty charm. Bharat Sthali brings you a wide selection of raw silk
                    dupion sarees that are perfect for you! Whether you want to make your special day more special or give your routine a special touch,
                    traditional weaving available here add a trendy and classy touch to your wardrobe.                </p>
            </div>
            <div id="product" className="row align-items-center mx-auto justify-content-center w-100">
                {product.Items8.map((resp, index) => (
